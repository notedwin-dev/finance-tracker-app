      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-invert prose-primary max-w-none space-y-8">
          <section>
            ...
            <p>
              ZenFinance ("we", "us", or "the app") is developed by **Edwin
              Ng**. Your privacy is of paramount importance. This Privacy Policy
              explains how ZenFinance handles your data, emphasizing our "Data
              Sovereignty" model where you, the **User**, remain in control of
          ...
          <section>
            ...
            <p>
              Unlike traditional financial apps, the **Developer** does not
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>
                <strong>Google Cloud Platform:</strong> For OAuth and Google
                Sheets API.
              </li>
              <li>
          ...
          <section>
            ...
            <p>
              Since the **Developer** never session-logs or stores your data on
              private servers, the security of your data largely depends on the
              security of your device and your Google Account. We recommend
